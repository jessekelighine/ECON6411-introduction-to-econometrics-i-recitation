...
\begin{tikzpicture}[thick,line cap=round,3d view={125}{20}]
	...
	\draw[very thick,myred,dashed] (O) -- node[pos=1,below]{$PY$} (Yhat);
	...
	\draw[dotted,myblue] (Y) -- node[pos=0.3,right]{$MY$} (Yhat);
